...
$(window).on("load", function () {
      userstable =$('#userstable').DataTable({
            ...
            initComplete: function () {
                ...
                $("#userstable_wrapper .dataTables_filter input").appendTo(_container);
                $("#userstable_wrapper .dt-filters").css("display", "none");
                $(_container).find("input").attr('placeholder', 'Search From Table');
                $("#userstable_wrapper .dt-bottom").appendTo(_bottom_container);
                dashboardFilters();
        ...
        $('#userstable thead tr').append('<th>Action</th>');
      ...
      function dashboardFilters() {
            $(".filterhead").each(function (i) {
                  ...
                  .on('change', function () {
                        ...
                        userstable.column(i).search(regExSearch, true, false).draw();
                  });
      ...
      var colvis = new $.fn.dataTable.ColVis(userstable, {
